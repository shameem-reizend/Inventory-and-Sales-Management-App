...
import { FaPen, FaTimes, FaSpinner } from 'react-icons/fa';
...
export const EditProduct: React.FC<ProductProps> = ({ product, onProductUpdated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiClient.put(`api/products/${product.id}`, {
        ...editedProduct,
        unitPrice: parseFloat(editedProduct.unitPrice) // Ensure number format
      });
